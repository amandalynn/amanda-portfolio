...
export const WORK: readonly WorkCard[] = [
  ...
  },
  {
    ...
    body: 'Started the design system across business units and coded it — tokens, a component library, and the front-end architecture behind the MyTeam dashboard. Designers and developers finally worked from one source of truth, and research kept it honest about what was worth solving.',
  ...
  },
  {
    ...
    body: 'Designed the member portal, then built it in .NET MVC — the front end and the controllers behind it. Led the Provider Portal redesign for 1M+ providers, took Bootstrap org-wide, and sat in on UI decisions across 10+ teams.',
