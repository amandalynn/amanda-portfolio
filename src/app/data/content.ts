...
export const WORK: readonly WorkCard[] = [
  {
    ...
    body: "Here since before the first customer, and now it's profitable. Full-stack on a multi-tenant SaaS platform — Angular v21 and reactive state, ASP.NET Core on EF Core, ClickHouse behind tenant reporting. Alongside it: encoding the design system where coding agents actually read it, so what they generate lands on pattern instead of beside it.",
  ...
  },
  {
    ...
    body: 'Started the design system across business units and coded it — tokens, a component library, and the front-end architecture behind the MyTeam dashboard. Designers and developers finally worked from one source of truth, with usage guidance and handoff rules that made it stick past launch. Research kept it honest about what was worth solving.',
  ...
  },
  {
    ...
    body: 'Designed the member portal, then built it in .NET MVC — the front end and the controllers behind it. Led the Provider Portal redesign for 1M+ providers, grounded in on-site visits and interviews with the people using it every day. Took Bootstrap org-wide and sat in on UI decisions across 10+ teams.',
...
export const TOOLBOX: readonly ToolboxColumn[] = [
  {
    ...
    items: [
      ...
      { text: 'React when it was the right fit' },
